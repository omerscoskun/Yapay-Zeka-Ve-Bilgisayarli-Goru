...
def isTolerablelySimilar(A,B,tolerance):

    similarity_ratio = vectorSimilarity(A,B)
...
tolerance_level = 0.8  # %80 == tolerans seviyesi
print("--------------------------------------------------")
print("Renk benzerlik algoritması - Toleranslı Benzerlik Algoritması")
print("Tolerans seviyesi: ",tolerance_level)
print("--------------------------------------------------")

benzerlik_orani = vectorSimilarity(kirmizi_normalized,koyuKirmizi_normalized)
is_similar = isTolerablelySimilar(kirmizi_normalized,koyuKirmizi_normalized,tolerance_level)
print("Kırmızı ile Koyu Kırmızı renkleri benzer mi?: ",is_similar) # Cevap yaklaşık True gelecektir.
...
is_similar = isTolerablelySimilar(siyah_normalized,beyaz_normalized,tolerance_level)
print("Siyah ile Beyaz renkleri benzer mi?: ",is_similar) # Cevap yaklaşık True gelecektir.
...
is_similar = isTolerablelySimilar(siyah_normalized,gri_normalized,tolerance_level)
print("Siyah ile Gri renkleri benzer mi?: ",is_similar) # Cevap yaklaşık True gelecektir.
print("Siyah ile Gri arasındaki renk benzerlik oranı: ",benzerlik_orani) # Cevap yaklaşık %50 gelecektir.
